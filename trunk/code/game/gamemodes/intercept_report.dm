...
/datum/intercept_text/proc/build_cult(datum/mind/correct_person)
	...
	if(prob(prob_right_job) && is_convertable_to_cult(correct_person))
		...
		job_tmp.Remove("Captain", "Chaplain", "AI", "Cyborg", "Security Officer", "Detective", "Head Of Security", "Lieutenant", "Chief Engineer", "Research Director", "Chief Medical Officer")
